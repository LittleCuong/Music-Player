...
const app = {
    ...
    hoverAnimation: function () {
        ...
        // Post Malone
        postMalone.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/GradientPost.PNG")',
                
            })   
        })
        postMalone.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
            // upperBody.classList.remove('post-malone-color')  
           
        })

        // Maroon 5
        maroon5.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/gradientMaroon.PNG")',
                
            })   
        })
        maroon5.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
        ...
        // The Weeknd
        theWeeknd.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/gradientTheWeeknd.PNG")',               
            })   
        })
        theWeeknd.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
        })

        // KDA
        kda.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/gradientKDA.PNG")',               
            })   
        })
        kda.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
        })

        // Vu
        vu.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/gradientVu.PNG")',               
            })   
        })
        vu.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
        })

        // Imagine Dragons
        imagineDragons.addEventListener("mouseover", function () {
            Object.assign(upperBody.style, {
                background: 'url("./img/gradientDragons.PNG")',               
            })   
        })
        imagineDragons.addEventListener("mouseout", function () {
            upperBody.style.background= "url('./img/Gradient\ 1.PNG')";
        })
    },
    ...
    handleEvents: function () {
        ...
        // likeSongBtn.onclick = function () {
        //     _this.isLiked = !_this.isLiked
        //     likeSongBtn.classList.toggle('liked', _this.isLiked)
        // }
    },
